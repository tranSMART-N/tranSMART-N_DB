CREATE OR REPLACE function tm_cz.I2B2_CREATE_SECURITY_FOR_TRIAL
(
  trial_id character varying
 ,secured_study character varying default 'N'
...
set search_path=tm_cz, i2b2demodata, i2b2metadata, searchapp, biomart, pg_temp;
