-- Function: tm_cz.i2b2_backout_trial(character varying, character varying, numeric)

-- DROP FUNCTION tm_cz.i2b2_backout_trial(character varying, character varying, numeric);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION tm_cz.i2b2_backout_trial(character varying, character varying, numeric) SET search_path=tm_cz, i2b2metadata, i2b2demodata, pg_temp;

ALTER FUNCTION tm_cz.i2b2_backout_trial(character varying, character varying, numeric) OWNER TO postgres;